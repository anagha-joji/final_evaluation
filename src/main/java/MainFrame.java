...
public class MainFrame {
    ...
    public static Connection connect() {
        ...
        try {
            ...
            Connection con = DriverManager.getConnection("jdbc:mysql://localhost:3306/library", "root", "Ab##cd**1999");
            return con;
        } catch (Exception ex) {
            ex.printStackTrace();
        }
    ...
    public static void user_frame(String UID) {
        ...
        //Creating Frame for Reader
        JFrame readerFrame = new JFrame("Reader Functions");
        ...
        //Setting Layout of the Reader frame.
        readerFrame.setLayout(new GridLayout(3, 1));

        //Adding all the components in the reader frame.
        readerFrame.add(view_books_btn);
        readerFrame.add(view_user_issued_books_btn);
        readerFrame.add(view_user_returned_books_btn);

        //Setting size of the reader frame (width,height)
    ...
    public static void admin_frame() {
        ...
        view_books_btn.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                //Query to retrive data from database
                String sql = "select * from BOOKS";
                try {
                    //Creating Statement
                    Statement stmt = connection.createStatement();
                ...
                create_btn.addActionListener(new ActionListener() {
                    ...
                    public void actionPerformed(ActionEvent e) {
                        ...
                        try {
                            ...
                            //If radio1 is click then it is added as admin, else normal reader
        ...
        add_issue_book_btn.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                l2 = new JLabel("Reader ID", SwingConstants.CENTER);
        ...
        //Setting the layout of Admin Frame
        adminFrame.setLayout(new GridLayout(2, 4));

        //Adding Reader components in the Reader Frame
        adminFrame.add(add_user_btn);
        adminFrame.add(add_book_btn);
        adminFrame.add(add_issue_book_btn);
        adminFrame.add(add_return_book_btn);
        adminFrame.add(view_users_btn);
        adminFrame.add(view_books_btn);
        adminFrame.add(view_issued_books_btn);
        adminFrame.add(view_returned_books_btn);

        //Setting size of the frame (width,height)
        adminFrame.setSize(800, 200);
